...
import 'package:foodfinder/ui/screens/restaurant/items/highlight.dart';
import 'package:foodfinder/ui/screens/widgets/custom_rating.dart';
import 'package:foodfinder/ui/screens/widgets/review_item.dart';
...
class RestaurantDetailScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      body: RestaurantDetailBody(restaurant: restaurant),
    );
  }
}
...
class RestaurantDetailBody extends StatefulWidget {
  RestaurantModel restaurant;
  RestaurantDetailBody({@required this.restaurant});
  @override
          ...
          builder: (context, restaurantProv, _) {
            ...
            if (restaurantProv.reviewList == null) {
              restaurantProv.getReviewByResID(
                  widget.restaurant.id.toString(), context);
              return Center(
