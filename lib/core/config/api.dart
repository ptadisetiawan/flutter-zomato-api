class Api {
  ...
  String getRestaurant =
      "$baseURL/search?lat=%latitude%&lon=%longitude%&radius=20000";
  ...
  String searchRestaurantByKeyword =
      "$baseURL/search?q=%keyword%&lat=%latitude%&lon=%longitude%&radius=20000";

  //* Find Restaurant by collection id Endopoint
  //* Please replace %collection_id%
  //* with your collection
  String getRestaurantByCollection =
      "$baseURL/search?collection_id=%collection_id%";
